...
insert into P6_RATE (RATE_CODE,TAUX) values ('TXCOM','0,5');

insert into  P6_PERSON (EMAIL,PASSWORD,FIRSTNAME,LASTNAME,BIC,IBAN,ACTIVE_FLG) values ('test1@gmail.com','***','Olivier','Martin','SOGEFRPP','300030407351233388889','1');
insert into  P6_PERSON (EMAIL,PASSWORD,FIRSTNAME,LASTNAME,BIC,IBAN,ACTIVE_FLG) values ('test2@gmail.com','***','Jean','Martin','SOGEFRPP','300030407351233386669','1');
insert into  P6_PERSON (EMAIL,PASSWORD,FIRSTNAME,LASTNAME,BIC,IBAN,ACTIVE_FLG) values ('test3@gmail.com','***','Arthur','Dardarin','SOGEFRPP','300030407351233377789','1');
insert into  P6_PERSON (EMAIL,PASSWORD,FIRSTNAME,LASTNAME,BIC,IBAN,ACTIVE_FLG) values ('test4@gmail.com','***','Virginie','Massot','SOGEFRPP','300030407351233311191','1');
insert into  P6_PERSON (EMAIL,PASSWORD,FIRSTNAME,LASTNAME,BIC,IBAN,ACTIVE_FLG) values ('test5@gmail.com','***','Maxime','Calice','SOGEFRPP','300030407351233344489','1');
insert into  P6_PERSON (EMAIL,PASSWORDFIRSTNAME,,LASTNAME,BIC,IBAN,ACTIVE_FLG) values ('test6@gmail.com','***','Claudia','Bozon','SOGEFRPP','300030407351233322284','1');
